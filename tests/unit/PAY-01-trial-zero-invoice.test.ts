...
// Store lock for PAY-01 (API-PAY-001). Does not claim Stripe E2E Closed.
// Break: convertStripeTrial(amountMinor=0) writing a full-term purchase.
...
test("PAY-01 store: convertStripeTrial with amountMinor=0 must keep the trial window", async () => {
