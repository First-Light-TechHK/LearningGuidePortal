...
Excerpt only. Suite is active. Id is copied from `UC-PORTAL-course-page-primitives.test.ts`. HTTP I/O for published-only catalogue, tourist access, and unpublished slug lives in `tests/io/portal.test.ts`.
