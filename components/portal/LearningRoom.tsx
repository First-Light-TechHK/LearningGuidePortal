...
export function LearningRoom({ locale, courseId, lesson, initialCompleted, copy }: { locale: "en-GB" | "zh-CN"; courseId: string; lesson: { id: string; title: string; body: string; durationMinutes: number; contents?: LessonContent[] }; initialCompleted: boolean; copy: { study: string; minutes: string; you: string; completeLesson: string; completed: string; tutor: string; lecture: string; socratic: string; send: string; askTutor: string } }) {
