...
- Production `PPE/PROD` requires `SES_FROM_EMAIL` for email verification and password reset. OAuth buttons are hidden unless the corresponding provider credentials are configured.
