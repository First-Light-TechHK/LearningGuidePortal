...
import { checkEntitlement, getLearningOverview, getProductCourse, listPlans, publicFirstLesson } from "@/services/productStore";
...
export default async function CourseDetailPage({
  ...
  const access = user ? await checkEntitlement(user.id, course.id) : { allowed: false, source: null, validTo: null };
  const study = user ? (await getLearningOverview(user.id)).courses.find((item) => item.courseId === course.id) : null;
